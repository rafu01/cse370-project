# Generated by Django 3.1.5 on 2021-01-19 13:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_logged_in', models.BooleanField(default=False, verbose_name='isLoggedIn')),
        ...
        migrations.AddField(
            model_name='products',
            name='status',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='showroom.status'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='customer',
            name='messages',
            field=models.ManyToManyField(blank=True, to='showroom.UserMessage'),
        ),
        migrations.AddField(
            model_name='customer',
            name='product',
